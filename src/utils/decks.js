...
export const decks = [
  {
    ...
    cards: [
      {title: 'Card 1', content: 'Test card number one! Woo!'},
      {title: 'Card 2', content: 'Holy shit this card is even better'},
      {title: 'Card 3', content: 'No way how do the cards keep getting better?'},
    ],
  },
  {
    number: 2,
